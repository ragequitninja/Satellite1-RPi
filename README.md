...
```bash
sat1 xmos {setup,read-firmware,read-status,reset,enable-flashing,disable-flashing,run-spi-test,set-mic-output,get-mic-pipeline-settings,set-mic-pipeline-settings,flash-firmware}
```
